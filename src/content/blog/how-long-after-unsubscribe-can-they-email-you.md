...
faq:
  ...
  - question: "What does 10 business days mean for unsubscribe requests?"
    answer: "Business days are weekdays only. Weekends and U.S. federal holidays do not count. So 10 business days after a Monday click lands two Fridays later, and a click right before a holiday week stretches the real-world wait even longer. The clock starts when you submit a valid opt-out, not when the sender gets around to reading it."
  - question: "How fast do Gmail and Yahoo require senders to unsubscribe you?"
    answer: "Within two days. Since February 2024, Gmail and Yahoo require bulk senders (those sending about 5,000 or more messages a day to their users) to support one-click unsubscribe and to process the request within 48 hours. This is a deliverability policy, not a law, but it is stricter and faster than the CAN-SPAM 10-business-day rule."
  - question: "Does GDPR have a deadline to stop marketing emails?"
    answer: "GDPR sets no fixed number of days. Article 7(3) says withdrawing consent must be as easy as giving it, and processing must stop without undue delay. In practice a modern automated system should remove you almost immediately. If a sender makes you log in, fill out a form, or contact support to opt out, that alone can breach the rule."
  - question: "Why am I still getting emails three days after unsubscribing?"
    answer: "Three days is still inside every legal grace window, so a delay this short is usually normal, not a violation. Large senders batch their list updates, so a campaign already queued when you unsubscribed can still land. Wait out the window. If it is a Gmail or Yahoo bulk sender, 48 hours is the yardstick; otherwise mark day 10 on your calendar."
  - question: "Is it illegal to email someone after they unsubscribe?"
    answer: "Not immediately. Both CAN-SPAM and GDPR build in time for the sender to process the request, so email inside that window is legitimate. It becomes a violation once the window closes and the emails keep coming. Under CAN-SPAM that line is 10 business days; a non-compliant sender past it can be reported to the FTC."
  - question: "What should I do if emails keep coming after 10 business days?"
    answer: "Mark the date you first unsubscribed, then block the sender at your email provider so the messages stop reaching you regardless of compliance. Keep the emails that arrived after the window as evidence. In the U.S., report the sender to the FTC; in the EU, file with your national data protection authority. Documented timestamps are what make a complaint actionable."
---
...
Subject: A hero cream-paper tear-off calendar sitting left-of-center as the dominant element, its top ten day-numbers ticked off in sequence and one loose page mid-tear. Beside it a round cream stopwatch with its hand pointing at an abstracted 48-mark. Around the cluster: a small hourglass with sand part-drained, a single unsubscribe button being pressed, and one cream envelope crossed out with a short bar. Hero calendar-and-stopwatch pairing sits centered in the middle 60% of the frame.
-->
...
Ten business days, if the sender falls under U.S. law. The [FTC's CAN-SPAM compliance guide](https://www.ftc.gov/business-guidance/resources/can-spam-act-compliance-guide-business) requires a commercial sender to honor your opt-out request within 10 business days. That is the outer limit of legitimate continued email after a clean unsubscribe.
...
So a compliant unsubscribe is one click or one short form, and the 10 business days run from that action. If a page instead asks you to log in, re-enter your password, or "confirm your identity," it is either non-compliant or a phishing trap. For how to tell a safe unsubscribe from a dangerous one before you click, see [is it safe to click unsubscribe?](/blog/is-it-safe-to-click-unsubscribe).

## Do Gmail and Yahoo make senders act faster than the law?

Yes, and by a wide margin. Since February 2024, Gmail and Yahoo have required their bulk senders to support one-click unsubscribe and to process the request within two days. Google's [sender guidelines](https://support.google.com/a/answer/81126) define a bulk sender as one sending close to 5,000 messages or more a day to personal Gmail accounts, and the same page states that senders should fulfill unsubscribe requests within 48 hours.

This is a deliverability policy, not a statute. Gmail and Yahoo cannot fine anyone. What they can do is route a non-compliant sender's mail to spam, which for a marketer is its own kind of penalty. The [one-click button](/blog/what-is-one-click-unsubscribe) rides on the `List-Unsubscribe` header defined in RFC 8058, and bulk senders had until June 1, 2024 to add it to every promotional message.
...
GDPR names no number of days at all. Instead, [Article 7(3)](https://gdpr-info.eu/art-7-gdpr/) says you may withdraw consent at any time and that withdrawing it must be as easy as giving it was. The cessation of processing has to happen without undue delay, which a modern automated system should read as "almost immediately."
...
After the window, the same email is a violation. Once 10 business days have passed (or 48 hours for a Gmail or Yahoo bulk sender) and messages keep arriving, the sender is no longer processing your request; it is ignoring it. That is the line the FTC and EU regulators care about. If you are still getting mail from a company you unsubscribed from weeks ago, the culprit is often that you left one list while the company runs several, so hunt for a "manage preferences" page that exposes all of them at once. Our [troubleshooting guide to why emails keep coming after you unsubscribe](/blog/unsubscribed-but-still-getting-emails) maps all seven causes to their fixes.
...
That is the gap the [Email Unsubscriber app](https://app.email-unsubscriber.com/) is built to close. It scans your inbox in your browser, dispatches one-click unsubscribes through the same RFC 8058 protocol Gmail and Yahoo mandate, and flags any sender still mailing you after you opted out with a "Still Emailing" marker. Your email content never leaves your device, and there is nothing to cancel, since it is a [one-off payment](/#pricing), not a subscription. The senders who ignore the 10-day rule stop being invisible, which is the first step to acting on them.
